...
#define MAXVER_INTERNALNAME "bevel\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "bevel.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Bevel and bevel profile modifiers (core plugin)\0"//should  be overidden on a per-dll level
